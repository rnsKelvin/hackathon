...
//npx hardhat run  scripts/listen.js
async function main() {
    ...
    list = []
    await pay.on("SubScribe", async (userAddress, merchantAddress) => {
        console.log("***********[SubScribe]*****************");
        console.log("userAddress:", userAddress);
        console.log("merchantAddress:", merchantAddress);
        list.push({user: userAddress, merchant: merchantAddress})
    ...
    tk = await pay.subScribe(accounts[0], _merchant);
    console.log(tk.toString())
    await pay.on("CancelSubScribe", async (userAddress, merchantAddress) => {
        console.log("***********[CancelSubScribe]*****************");
        console.log("userAddress:", userAddress);
        console.log("merchantAddress:", merchantAddress);
        list = list.filter(item => item != {user: userAddress, merchant: merchantAddress})
